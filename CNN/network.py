...
Date: June 12th, 2018
'''
from CNN.forward import convolution, maxpool, softmax, categoricalCrossEntropy
from CNN.backward import maxpoolBackward, convolutionBackward
...
def train_cnn_np(num_classes = 10, lr = 0.01, beta1 = 0.95, beta2 = 0.99, img_dim = 28, img_depth = 1, f = 5, num_filt1 = 8, num_filt2 = 8, batch_size = 32, num_epochs = 2, save_path = 'params.pkl', m =50000):
    # num_classes = 10; lr = 0.01; beta1 = 0.95; beta2 = 0.99; img_dim = 28; img_depth = 1; f = 5; num_filt1 = 8; num_filt2 = 8; batch_size = 32; num_epochs = 2; save_path = 'params.pkl'; m =50000
    # training data
    ...
    for epoch in range(num_epochs):
        ...
        for batch in t:
            params, cost = adamGD(batch = batch,
